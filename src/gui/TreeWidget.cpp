...
public:
	...
	TreeItemClientData *GetData() const {
		return m_data;
	}
	...
	void SetData(TreeItemClientData *data) {
		m_data = data;
	}
...
private:
	...
	TreeItemClientData     *m_data;         // user-provided data
...
//IMPLEMENT_DYNAMIC_CLASS2(TreeWidget, MyGenericTreeCtrl, KeyEventObserver)
IMPLEMENT_CLASS2(TreeWidget, MyGenericTreeCtrl, KeyEventObserver)
...
void MyGenericTreeCtrl::SetIndent(uint indent)
{
	m_indent = (unsigned short) indent;
	m_dirty = TRUE;
}

void MyGenericTreeCtrl::SetSpacing(uint spacing)
{
...
TreeItemClientData *MyGenericTreeCtrl::GetItemData(const wxTreeItemId& item) const
{
...
void MyGenericTreeCtrl::SetItemData(const wxTreeItemId& item, TreeItemClientData *data)
{
	wxCHECK_RET( item.IsOk(), wxT("invalid tree item") );
