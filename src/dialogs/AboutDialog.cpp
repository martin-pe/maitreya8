...
void AboutDialog::do_layout()
{
    ...
    sizer_main->Add(panel_logo, 1, wxALIGN_CENTER|wxALL, 3);
    ...
    sizer_about->Add(sizer_author, 1, wxALIGN_CENTER|wxALL|wxEXPAND, 3);
    ...
    sizer_main->Add(button_ok, 0, wxALIGN_CENTER|wxALL, 3);
    SetSizer(sizer_main);
    sizer_main->Fit(this);
