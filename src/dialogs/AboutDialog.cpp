		...
		: wxDialog( parent, -1, wxT( "" ), wxDefaultPosition, wxDefaultSize, DEFAULT_DIALOG_STYLE )
{
    ...
    sizer_author_staticbox = new wxStaticBox(pane_about, wxID_ANY, _("Author"));
    sizer_versions_staticbox = new wxStaticBox(pane_about, wxID_ANY, _("Versions"));
    sizer_software_staticbox = new wxStaticBox(pane_about, wxID_ANY, _("Software"));
...
void AboutDialog::do_layout()
{
    ...
    sizer_software_staticbox->Lower();
    ...
    sizer_versions_staticbox->Lower();
    wxStaticBoxSizer* sizer_versions = new wxStaticBoxSizer(sizer_versions_staticbox, wxVERTICAL);
    wxFlexGridSizer* grid_versions = new wxFlexGridSizer(5, 2, 0, 5);
    sizer_author_staticbox->Lower();
    ...
    sizer_main->Add(panel_logo, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 3);
    sizer_author->Add(label_author, 0, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 3);
    sizer_author->Add(label_url, 0, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 3);
    sizer_author->Add(label_dedicate, 0, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 3);
    sizer_about->Add(sizer_author, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 3);
    grid_versions->Add(label_title_version, 0, wxALL|wxALIGN_CENTER_VERTICAL, 3);
    grid_versions->Add(label_version, 0, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 3);
    grid_versions->Add(label_title_wx, 0, wxALL|wxALIGN_CENTER_VERTICAL, 3);
    grid_versions->Add(label_version_wx, 0, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 3);
    grid_versions->Add(label_title_swe, 0, wxALL|wxALIGN_CENTER_VERTICAL, 3);
    grid_versions->Add(label_version_swe, 0, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 3);
    grid_versions->Add(label_title_wxsqlite, 0, wxALL|wxALIGN_CENTER_VERTICAL, 3);
    grid_versions->Add(label_version_wxsqlite3, 0, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 3);
    grid_versions->Add(label_title_wxpdfdoc, 0, wxALL|wxALIGN_CENTER_VERTICAL, 3);
    grid_versions->Add(label_version_wxpdfdoc, 0, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 3);
    grid_versions->AddGrowableCol(1);
    sizer_versions->Add(grid_versions, 1, wxALL|wxEXPAND, 3);
    sizer_about->Add(sizer_versions, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL, 3);
    grid_software->Add(label_title_builddate, 0, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 3);
    grid_software->Add(label_builddate, 0, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 3);
    grid_software->Add(label_title_compiler, 0, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 3);
    grid_software->Add(label_compiler, 0, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 3);
    grid_software->Add(label_title_unicode, 0, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 3);
    grid_software->Add(label_unicode, 0, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 3);
    grid_software->Add(label_title_os, 0, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 3);
    grid_software->Add(label_os, 0, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 3);
    ...
    sizer_main->Add(button_ok, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 3);
    SetSizer(sizer_main);
    sizer_main->Fit(this);
