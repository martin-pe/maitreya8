...
MiscellaneousPanel::MiscellaneousPanel( wxWindow* parent ) : ConfigPanel( parent )
{
    ...
    choice_input_field_validation = new wxChoice(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, 3, choice_input_field_validation_choices, 0);
...
void MiscellaneousPanel::do_layout()
{
    ...
    grid_misc->Add(label_input_field_validation, 0, wxALL|wxALIGN_CENTER_VERTICAL, 3);
    grid_misc->Add(choice_input_field_validation, 0, wxALL|wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, 3);
