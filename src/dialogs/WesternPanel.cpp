...
WesternPanel::WesternPanel( wxWindow* parent ) : ConfigPanel( parent )
{
	...
	check_objects_uranian_inner->SetValidator( MBooleanFlagValidator( (int*)&wconfig->objects, (int)OI_URANIAN_INNER ));
	check_objects_uranian_outer->SetValidator( MBooleanFlagValidator( (int*)&wconfig->objects, (int)OI_URANIAN_OUTER ));
...
void WesternPanel::set_properties()
{
    ...
    check_objects_dragonhead->SetToolTip(_("Northern Lunar Node, Rahu"));
    check_objects_dragontail->SetToolTip(_("Southern Lunar Node, Ketu"));
    check_objects_meridian->SetToolTip(_("Midheaven"));
    check_objects_descendant->SetToolTip(_("Descending Point of the Ecliptic"));
    ...
    check_main_element->SetToolTip(_("Fire, Earth, Air and Water"));
    check_main_quality->SetToolTip(_("Movable, Fixed, Dual"));
    // end wxGlade
}
